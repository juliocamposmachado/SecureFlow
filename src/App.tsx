            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-white/20">
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
                  <a href="mailto:juliocamposmachado@gmail.com" className="text-emerald-400 hover:text-emerald-300 transition-colors">
                    juliocamposmachado@gmail.com
                  </a>
                  <span className="hidden sm:inline text-slate-600">•</span>
                  <a href="tel:+5511970603441" className="text-emerald-400 hover:text-emerald-300 transition-colors">
                    +55 11 97060-3441
                  </a>
                  <span className="hidden sm:inline text-slate-600">•</span>
